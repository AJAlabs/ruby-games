...
# This colorize library is a great alternative to using the gem for ruby in the console or on the command-line
# You can find the colorize ruby gem at: https://github.com/fazibear/colorize
